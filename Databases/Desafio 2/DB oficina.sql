...
ALTER TABLE Veiculo 
    ADD CONSTRAINT fk_eqp_mecanicos FOREIGN KEY (idVeiculo) REFERENCES EqpMecanico(idEqpMecanico),
...
ALTER TABLE PessoaFisica 
    ADD CONSTRAINT unique_cpf_PessoaFisica UNIQUE (CPF),
...
ALTER TABLE OdServiço 
    ADD CONSTRAINT fk_OdServiço FOREIGN KEY (idOdServiço) REFERENCES OdServiço(idOdServiço);
